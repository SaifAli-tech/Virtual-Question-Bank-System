  ...
  questions: Joi.array()
    .items(
      Joi.string().required().messages({
        "string.base": '"mcq question" should be a type of text',
        "any.required": '"mcq question" is a required field',
      })
    )
    .required()
    .messages({
...
// Function to validate mcq exam data
const validate = (data) => mcqExamDto.validate(data, { abortEarly: false });
