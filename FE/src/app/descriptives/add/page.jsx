...
const AddDescriptiveQuestion = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await apiClient.post("/descriptives", values);
        Swal.fire({
          icon: "success",
          color: "green",
          title: "Success",
          text: `Descriptive question "${values.text}" added successfully!`,
        });
        formik.resetForm();
      } catch (error) {
...
export default withAuth(AddDescriptiveQuestion, ["Admin", "Teacher"]);
